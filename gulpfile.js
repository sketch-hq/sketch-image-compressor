...
gulp.task('assemble-plugin-resources', function (callback) {
  var resourceTarget = path.join(__dirname, 'dist', normalizePluginFileName(), 'Contents/Resources')
  copy('src/resources', resourceTarget, { overwrite: true }, function(error, results){
    console.log('Plugin resources assembled')
...
gulp.task('build', function (callback) {
  runSequence('clean', 'prepare-folders', 'bundle', 'prepare-manifest', 'assemble-plugin-bundle', 'assemble-plugin-resources', 'uglify', 'install-plugin', callback);
});
